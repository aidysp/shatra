...
import { Shatra, Biy } from "../figure";
import { Player } from "../config";

export class BoardVisualizer {
    static printBoard(board: ShatraBoard, forPlayer: Player = Player.BLACK): void {
    ...
    static printBoardForWhite(board: ShatraBoard): void {
        this.printBoard(board, Player.WHITE);
    }


    static printBoardForBlack(board: ShatraBoard): void {
